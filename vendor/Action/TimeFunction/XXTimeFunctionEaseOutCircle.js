 ...
 */
function xxfEaseOutCircle(t: number,
                         b: number,
                         c: number,
                         d: number): number {
...
/**
 * 用来表示ease out circle的time function
 * http://easings.net/zh-cn
 */
class XXTimeFunctionEaseOutCircle extends XXObject
  ...
  easeFunction(elapseTime: number,
    ...
    // y = c * Math.sqrt(1 - (t=t/d-1)*t) + b;
    // https://github.com/danro/jquery-easing/blob/master/jquery.easing.js
    return xxfEaseOutCircle(elapseTime, begin, change, duration);
  }
}

export default XXTimeFunctionEaseOutCircle;
