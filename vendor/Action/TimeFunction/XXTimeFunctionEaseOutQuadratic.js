...
/**
 * [xxfEaseOutQuadratic description]
 ...
 */
function xxfEaseOutQuadratic(t: number,
                            b: number,
                            c: number,
                            d: number): number {
  return -c *(t/=d)*(t-2) + b;
...
/**
 * 用来表示ease out quadratic的time function
 * http://easings.net/zh-cn
 */
class XXTimeFunctionEaseOutQuadratic extends XXObject
  ...
  easeFunction(elapseTime: number,
    ...
    return xxfEaseOutQuadratic(elapseTime, begin, change, duration);
  }
}

export default XXTimeFunctionEaseOutQuadratic;
