...
/**
 * [xxfEaseInOutQuintic description]
 ...
 */
function xxfEaseInOutQuintic(t: number,
                             b: number,
                             c: number,
                             d: number): number {
  if ((t/=d/2) < 1) {
...
/**
 * 用来表示ease in out quintic function
 * http://easings.net/zh-cn
 */
class XXTimeFunctionEaseInOutQuintic extends XXObject
  ...
  easeFunction(elapseTime: number,
    ...
    return xxfEaseInOutQuintic(elapseTime, begin, change, duration);
  }
}

export default XXTimeFunctionEaseInOutQuintic;
