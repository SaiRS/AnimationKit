 ...
 */
function xxfEaseInQuartic(t: number,
                          b: number,
                          c: number,
                          d: number): number {
...
/**
 * 用来表示ease in quaritic function
 * http://easings.net/zh-cn
 */
class XXTimeFunctionEaseInQuartic extends XXObject
  ...
  easeFunction(elapseTime: number,
    ...
    return xxfEaseInQuartic(elapseTime, begin, change, duration);
  }
}

export default XXTimeFunctionEaseInQuartic;
