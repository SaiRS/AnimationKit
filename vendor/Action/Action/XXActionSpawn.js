...
class XXActionSpawn extends XXActionInterval {
   ...
   */
  initWithActionoOneTwo(actionOne: XXActionInterval,
    actionTwo: XXActionInterval) {
    if (actionOne.getDuration() > actionTwo.getDuration()) {
      let delayAction =
        new XXActionDelay(actionOne.getDuration() - actionTwo.getDuration());
      ...
      let delayAction =
        new XXActionDelay(actionTwo.getDuration() - actionOne.getDuration());
